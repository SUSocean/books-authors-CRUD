...
//        AuthorEntity updatedAuthorEntity = underTest.save(authorEntityA);
//
//        Optional<AuthorEntity> result = underTest.findById(authorEntityA.getId());
//
//        assertThat(result).isPresent();
//        assertThat(result.get()).isEqualTo(updatedAuthorEntity);
//    }
//
//    @Test
...
//
//    @Test
//    public void testThatGetAuthorsWithAgeLessThat(){
//        AuthorEntity authorEntityA = TestDataUtil.createTestAuthorA();
...
//
//        Iterable<AuthorEntity> result = underTest.ageLessThan(25);
//
